...
const API_KEY = "354c2180"; // Reemplaza con tu propia API key de OMDb
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 40 }}>
        ...
        {movieData && (
          <View style={styles.result}>
            ...
            {/* Ratings */}
            <Text style={[styles.label, { marginTop: 16, fontSize: 18 }]}>
              Ratings:
            </Text>
            {movieData.Ratings && movieData.Ratings.length > 0 ? (
              ...
              <Text style={styles.ratingText}>No ratings available</Text>
            )}
          </View>
        )}
      </ScrollView>
